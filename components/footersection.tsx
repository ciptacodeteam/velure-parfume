...
const navigation = {
    ...
    social: [
        {
            name: 'Shopee',
            href: 'https://shopee.co.id/namatoko', // ganti sesuai link tokomu
        ...
        {
            name: 'Tokopedia',
            href: 'https://tokopedia.com/namatoko', // ganti sesuai link tokomu
            icon: (props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) => (
        ...
        {
            name: 'Instagram',
            href: 'https://instagram.com/namatoko', // ganti IG kamu
            icon: (props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) => (
